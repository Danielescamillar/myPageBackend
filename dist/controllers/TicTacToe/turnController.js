...
exports.deleteTurn = exports.createTurn = exports.getTurns = void 0;
const turnService = __importStar(require("../../services/TicTacToe/turnService"));
const getTurns = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const turn = yield turnService.getTurn();
    res.json(turn);
});
exports.getTurns = getTurns;
const createTurn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    const turn = yield turnService.createTurn(body);
    if (turn) {
