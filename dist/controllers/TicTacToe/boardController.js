...
const boardService = __importStar(require("../../services/TicTacToe/boardService"));
const getBoard = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const board = yield boardService.getBoard();
    res.json(board);
});
exports.getBoard = getBoard;
const createBoard = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    const board = yield boardService.createBoard(body);
    if (board) {
...
const deleteBoard = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const board = yield boardService.deleteBoard();
    if (board) {
        res.status(201).json(board);
    }
    else {
