...
exports.createSkillByBody = exports.getSkillById = exports.getAllSkills = void 0;
...
const getSkillById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const skill = yield skillService.getSkillById(id);
    if (skill) {
        res.json(skill);
    }
    else {
...
const createSkillByBody = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    const skill = yield skillService.createSkill(body);
    if (skill) {
...
exports.createSkillByBody = createSkillByBody;
